                ...
                <Shell title={data.bounty?.title}>
                    <div className="grid grid-cols-3 gap-x-8 border rounded-lg bg-gray-50 px-10 py-8">
                        ...
                        <div>
                            ...
                            <a href={data.bounty?.github || ""} target="_blank" rel="noreferrer" className="flex space-x-4 text-gray-900 border bg-white rounded-lg px-5 py-2">
                                <div className="pt-1.5">
                                    <svg xmlns="http://www.w3.org/2000/svg" className="w-10 h-10 text-gray-900"
                                         viewBox="0 0 24 24">
                                        <path
                                ...
                                <div className="pt-0.5 mb-1.5 w-full flex">
                                    <div>
                                        ...
                                        <p className="text-gray-900 font-medium text-xl leading-5">GitHub</p>
                                    </div>
                            ...
                            {data.user?.projectId === data.bounty?.project.id && (
                                <>
                                    <h2 className="text-3xl font-cal text-orange-900 mt-8 mb-2">Admin</h2>
