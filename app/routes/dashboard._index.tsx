...
export default function Index() {
          ...
          <Shell title="Dashboard">
            <div className="py-16">
              ...
              <div className="grid grid-cols-3 gap-4">
                <div className="border border-dashed border-orange-900 rounded px-4 py-2 text-gray-900">
  ...
  return (
    <div>
      <SignedIn>
        <Shell title="Dashboard">
          <div className="mb-16 border rounded-lg bg-gray-50 px-10 py-8">
            <h2 className="text-3xl font-cal text-gray-900 mb-4">🏆 Best Submission Prizes</h2>
          ...
          {data.projects.map((project) => (
            <div
              key={project.id}
              className="mb-16 border rounded-lg bg-gray-50 px-10 py-8"
            >
              <div className="flex">
                ...
                <div className="ml-auto space-x-4 mt-2">
                  ...
                  {project.support && (
                    <a
                      ...
                      className="text-orange-500 hover:text-orange-700 text-lg font-medium tracking-tight"
                    >
                      <ChatBubbleOvalLeftEllipsisIcon className="w-4 h-4 mb-0.5 inline-block" />{" "}
                      Get help
                    </a>
                  )}
                </div>
                ...
                {project.bounties.length === 0 && (
                  <div className="bg-white border border-gray-300 border-b-4 border-b-gray-200 rounded-lg px-5 py-24 col-span-3 text-center">
                    ...
                    <p className="text-gray-500 text-sm">
                      {project.name} has ran out of bounties. Check back soon!
                    </p>
                  </div>
                )}
              </div>
...
export const loader = async (args) => {
  ...
  return json({
    user,
    projects,
    allocated: totalValue._sum.value,
